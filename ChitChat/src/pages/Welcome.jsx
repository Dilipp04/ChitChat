...
const Welcome = () => {
  ...
  return (
    ...
    <div className={`grow dark:bg-darkgray dark:text-white bg-white ${location.pathname=="/app"?"hidden":"flex"} border-slate-200 rounded-lg p-2 md:flex flex-col justify-center `} >
